...
BEGIN
  ...
  RETURN 'RFQ' || LPAD(next_id::TEXT, 3, '0');
END;
$$ LANGUAGE plpgsql;
...
BEGIN
  ...
  RETURN 'QUO' || LPAD(next_id::TEXT, 3, '0');
END;
$$ LANGUAGE plpgsql;
...
INSERT INTO public.profiles (id, name, company, mobile, address, gst, role)
VALUES 
  ('00000000-0000-0000-0000-000000000001', 'John Doe', 'Tech Solutions Pvt Ltd', '+91 98765 43210', '123 Business District, Mumbai 400001', '27ABCDE1234F1Z5', 'customer'),
  ('00000000-0000-0000-0000-000000000002', 'TechComponents Ltd', 'TechComponents Ltd', '+91 98765 43211', '456 Industrial Area, Pune 411001', '27FGHIJ5678K2L6', 'supplier');